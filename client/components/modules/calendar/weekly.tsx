...
export default function Weekly(props: any) {
  ...
  return (
    <div className="">
      <div className="w-full bg-gray-200 shadow-inner flex justify-center md:divide-gray-200">
        <div className="rounded-lg px-8 pt-8 pb-6 w-[8.5in] md:pr-14">
          ...
          <div className="grid grid-cols-7 mt-8 text-md leading-6 text-center text-gray-700">
            <div>S</div>
            <div>M</div>
            <div>T</div>
            <div>W</div>
